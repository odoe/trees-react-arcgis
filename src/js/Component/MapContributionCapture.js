...
export default class MapContributionCapture extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      status: 'loading',
  ...
  handleLoad(map, view) {
    loadModules(['esri/widgets/Search']).then(([ Search ]) => {
      ...
      source.resultSymbol = {
        type: 'picture-marker',
        url: 'https://s3-us-west-1.amazonaws.com/patterns.esri.com/icons/Web/Point%20Symbols/SVG/Street%20trees_d.svg',
        width: '24px',
        height: '24px',
        yoffset: '10px'
      };
